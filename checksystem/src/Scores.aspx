...
<asp:Content runat="server" ContentPlaceHolderID="Body">
	...
	<asp:Repeater runat="server" ID="ScoresList" ItemType="main.Score">
		...
		<ItemTemplate><tr><td class="scores-img" style="background-image:url(/static/img/avatars/<%#:Item.Avatar ?? "default.gif"%>)"></td><td class="scores-name"><%#:Item.Name%><br/><span class="scores-area"><%#:Item.Area%></span></td><td><%#:GetStars(Item.Stars)%></td><td class="scores-prcent"><%#:Item.Value.ToString("P0")%></td></tr></ItemTemplate>
