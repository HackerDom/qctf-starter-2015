...
$(function(){function a(b){b.stop(!0,!0).animate({scrollTop:b.prop("scrollHeight")},300)}function f(){a($(".chat-history"))}function g(){a($(".files-history"))}function h(b){b.css({"background-color":"rgba(100, 255, 100, 0.25)"}).delay(3E3).animate({backgroundColor:"transparent"},1E3)}function k(){$(".header").append($("<span class='star'></span>"))}function l(){var b=$("<tr class='chat-msg-wait'><td colspan='3'>Waiting for response...</td></tr>");$(".chat-msg-tbl tbody").append(b);$(".chat-history").perfectScrollbar("update");
